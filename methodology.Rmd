...
In order to provide a graph the 
...
complete <- left_join(lac_sez, allLACzones[c("iso3c","Harmful_COCG", "Harmful_OECD_FHTP", "Harmfulregimesfound","Regimeassessed")])
...
EUzones %<>% filter(!identifier%in% c("BE008","DE006", "HR002", "HR003", "HR005", "IE007", "RO002", "GE004", "VN005")) 
nrow(EUzones)
